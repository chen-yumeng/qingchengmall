...
import com.cg.qingcheng.service.goods.SpecService;
...
/**
 * @program: qingcheng_parent->SpecController
 * @description:
 * @author: cg
...
public class SpecController {
    ...
    public List<Spec> findSpecByTemplateId(String id) {
        return specService.findSpecByTemplateId(id);
    }
